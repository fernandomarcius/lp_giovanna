/**
 * Unified Tailwind Configuration for Giovanna Seabra Landing Page
 * This config is shared across all pages to ensure design consistency
 */
    ...
    theme: {
        extend: {
            ...
            boxShadow: {
                ...
                'strong': '0 20px 25px -5px rgba(0, 0, 0, 0.15), 0 10px 10px -5px rgba(0, 0, 0, 0.08)'
            },
            backgroundImage: {
